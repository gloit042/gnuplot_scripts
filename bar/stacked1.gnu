...
plot 'stacked.dat' using ($2+$3+$4+$5+$6+$7) notitle with boxes fs pattern 0 lc rgb 'black',  \
     ''            using ($2+$3+$4+$5+$6) notitle with boxes fs pattern 5 lc rgb 'black', \
     ''            using ($2+$3+$4+$5) notitle with boxes fs pattern 1 lc rgb 'black', \
     ''            using ($2+$3+$4) notitle with boxes fill lc rgb 'gray', \
     ''            using ($2+$3) notitle  with boxes fs pattern 2 lc rgb 'black', \
     ''            using ($2) notitle with boxes fs pattern 3 lc rgb 'black', \
